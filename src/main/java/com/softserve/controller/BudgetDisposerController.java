...
@WebServlet("/budget-disposer")
public class BudgetDisposerController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/WEB-INF/pages/budget-disposer.jsp");

        try {
            request.setAttribute("budget", repositoryBudget.getAllDisposer());
